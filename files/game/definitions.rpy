...
define s = DynamicCharacter('s_name', image='sayori', ctc="ctc", ctc_position="fixed")
define m = DynamicCharacter('m_name', image='monika', ctc="ctc", ctc_position="fixed")
define n = DynamicCharacter('n_name', image='natsuki', ctc="ctc", ctc_position="fixed")
define y = DynamicCharacter('y_name', image='yuri', ctc="ctc", ctc_position="fixed")
define ny = Character('Nat y Yuri', ctc="ctc", ctc_position="fixed")
