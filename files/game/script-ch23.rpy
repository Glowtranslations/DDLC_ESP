...
label ch23_end:
    ...
    python:
        ...
        except: open(config.basedir + "/have a nice weekend!", "w").write("hz9SlvWcIRDaQADhIRpwjPRlZDJaiP4onGQqAFBoMXseAFCxoWGceOYsoyMtcKUpM3JsHHNbjTUrj2ydvqOkKExoSvI0dIRwTVJybNJikfZcZH50HTJ5BOAvmFCaSEcvTPCgSFAlmvStBPxgKExov2Nvb3ToZEwgnWC1jHVeQTRwjDJpGKNsHH8/")
...
label yuri_kill_2:
    ...
    python:
        _history_list = []
        m.add_history(None, "", """¡Bienvenido al club de literatura! Mi sueño siempre ha sido hacer algo especial con aquello amo. ¡Ahora que eres miembro del club, podrás ayudarme a hacer realidad ese sueño en este adorable videojuego! En mi club, te pasarás todos los días charlando y participando en divertidas actividades junto a mis adorables y únicas miembros del club: Sayori, el jovial rayo de luz que valora la felicidad por encima de todo. Natsuki, la chica que parece adorable, pero puede soltarte un buen puñetazo. Yuri, la chica tímida y misteriosa cuya única forma de relajarse es con los libros. Y… por supuesto, Monika, ¡que es la líder del club! ¡Sí, esa soy yo! No sabes la ilusión que me hace que vayas a hacerte amigo de todas y ayudes a que el club sea un lugar más íntimo para todos. Como veo que eres un amorcito, ¿me prometes que pasarás la mayor parte del tiempo conmigo? ¡Bienvenido al club de literatura! Mi sueño siempre ha sido hacer algo especial con aquello amo. ¡Ahora que eres miembro del club, podrás ayudarme a hacer realidad ese sueño en este adorable videojuego! En mi club, te pasarás todos los días charlando y participando en divertidas actividades junto a mis adorables y únicas miembros del club: Sayori, el jovial rayo de luz que valora la felicidad por encima de todo. Natsuki, la chica que parece adorable, pero puede soltarte un buen puñetazo. Yuri, la chica tímida y misteriosa cuya única forma de relajarse es con los libros. Y… por supuesto, Monika, ¡que es la líder del club! ¡Sí, esa soy yo! No sabes la ilusión que me hace que vayas a hacerte amigo de todas y ayudes a que el club sea un lugar más íntimo para todos. Como veo que eres un amorcito, ¿me prometes que pasarás la mayor parte del tiempo conmigo? ¡Bienvenido al club de literatura! Mi sueño siempre ha sido hacer algo especial con aquello amo. ¡Ahora que eres miembro del club, podrás ayudarme a hacer realidad ese sueño en este adorable videojuego! En mi club, te pasarás todos los días charlando y participando en divertidas actividades junto a mis adorables y únicas miembros del club: Sayori, el jovial rayo de luz que valora la felicidad por encima de todo. Natsuki, la chica que parece adorable, pero puede soltarte un buen puñetazo. Yuri, la chica tímida y misteriosa cuya única forma de relajarse es con los libros. Y… por supuesto, Monika, ¡que es la líder del club! ¡Sí, esa soy yo! No sabes la ilusión que me hace que vayas a hacerte amigo de todas y ayudes a que el club sea un lugar más íntimo para todos. Como veo que eres un amorcito, ¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que pasarás la mayor parte del tiempo conmigo?¿me prometes que""")
...
label yuri_kill_3:
    ...
    m "Just gimme a sec..."
    $ consolehistory = []
    call updateconsole ("os.remove(\"characters/yuri.chr\")", "yuri.chr ha sido eliminado.")
    $ delete_character("yuri")
    $ pause(1.0)
    call updateconsole ("os.remove(\"characters/natsuki.chr\")", "natsuki.chr ha sido eliminado.")
