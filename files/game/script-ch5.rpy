...
image fake_exception = Text("Se ha producido una excepción.", size=40, style="_default")
image fake_exception2 = Text("Archivo \"game/script-ch5.rpy\", línea 307\nConsulte el archivo traceback.txt para más detalles.", size=20, style="_default")
...
label ch5_main:
    ...
    show fake_exception2 zorder 2:
        xpos 0.1 ypos 0.15
    python:
        try: sys.modules['renpy.error'].report_exception("Cielos... No habré roto nada, ¿verdad? Un segundo, esto puedo arreglarlo... Creo...\nEn verdad, ¿sabes qué? Esto será mucho más fácil si la elimino y ya.\nElla es quien está complicándolo tanto todo. ¡Ja, ja, ja!\nBueno, ya está, se te verá bien en un instante.", False)
        except: pass
    $ pause(6.0)
