...
label natsuki_exclusive2_1:
    ...
    $ style.say_dialogue = style.normal
    $ _history_list[-1].what = "Maldita Monika..."
    ...
    $ _history_list[-1].what = "Considera esto una lección del club de Literatura: ¡No juzgues a un libro solo por su portada!"
    $ style.say_dialogue = style.edited
    ...
    $ style.say_dialogue = style.normal
    $ _history_list[-1].what = "No sé qué sería capaz de hacer mi padre si lo encontrase."
