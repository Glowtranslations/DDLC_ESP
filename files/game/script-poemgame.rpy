init python:
    ...
    full_wordlist = []
    with codecs.open('./game/tl/spanish/poemwords.txt', encoding='utf-8') as wordfile:
...
label poem(transition=True):
    ...
    if persistent.playthrough == 0 and chapter == 0:
        call screen dialog("¡Es el momento de componer un poema!\n\nEscoge las palabras que creas que le gustarán\na la chica a quien quieras dedicárselo.\n¡Quizá pase algo especial si le acaba gustando!", ok_action=Return())
    python:
