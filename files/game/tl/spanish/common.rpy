...
translate Spanish strings:
    ...
    new "Archivo de guardado %s: [text]"

    # 00action_file.rpy:434
    old "Load slot %s: [text]"
    new "Archivo de cargado %s: [text]"

    # 00action_file.rpy:487
    old "Delete slot [text]"
    new "Eliminar archivo [text]"

    # 00action_file.rpy:569
    old "File page auto"
    new "Archivo de historia automático"

    # 00action_file.rpy:571
    old "File page quick"
    new "Archivo de avance rápido"

    # 00action_file.rpy:573
    old "File page [text]"
    new "Archivo de historia [text]"
    ...
    new "Se ha completado el guardado rápido."
    ...
    new "¿Estás seguro de que quieres eliminar esta partida?"

    # 00gui.rpy:372
    old "Are you sure you want to overwrite your save?"
    new "¿Estás seguro de que quieres sobrescribir esta partida?"

    # 00gui.rpy:373
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Si cargas el archivo perderás tus progresos.\n¿Estás seguro de querer hacerlo?"
    ...
    new "¿Estás seguro de querer volver al menú principal?\nPerderás los progresos no guardados."

    # 00gui.rpy:376
    old "Are you sure you want to end the replay?"
    new "¿Estás seguro de querer finalizar la repetición?"

    # 00gui.rpy:377
    old "Are you sure you want to begin skipping?"
    new "¿Estás seguro de querer saltarte el texto?"

    # 00gui.rpy:378
    old "Are you sure you want to skip to the next choice?"
    new "¿Estás seguro de querer avanzar hasta la siguiente elección?"

    # 00gui.rpy:379
    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "¿Estás seguro de querer saltarte el texto no visto hasta la siguiente elección?"

    # 00keymap.rpy:258
    old "Failed to save screenshot as %s."
    new "Error al guardar la captura de pantalla en %s."

    # 00keymap.rpy:270
    old "Saved screenshot as %s."
    new "Se ha guardado la captura de pantalla en %s."
    ...
    # 00library.rpy:193
    old "Skip Mode"
    new "Modo avance automático"

    # 00library.rpy:279
    old "This program contains free software under a number of licenses, including the MIT License and GNU Lesser General Public License. A complete list of software, including links to full source code, can be found {a=https://www.renpy.org/l/license}here{/a}."
    new "Este programa tiene una software libre bajo unas cantidad de licencias, incluida una licencia MIT y una licencia GNU. El listado completo de software, incluido el código fuente completo se encuentra en este {a=https://www.renpy.org/l/license}enlace{/a}."
    ...
    new "Saltar texto no visto [text]"
    ...
    new "avance rápido después de hacer click"
    ...
    new "Selecciona el mando a calibrar"
