...
translate Spanish ch21_main_0762f28d:
    ...
    y 1a "Espero que esto no se te haga muy pesado."
...
translate Spanish ch21_main_f114fc18:
    ...
    n 4e "Monika tuvo que suplicarte para que vinieras."
...
translate Spanish ch21_main_e6e52d65:
    ...
    n "No sé si tu plan es venir aquí y pasar el rato o..."
...
translate Spanish ch21_main_036357ba:
    ...
    "Derrotada, rápidamente se sentó en su sitio."
...
translate Spanish ch21_main_13b672c8:
    ...
    y "Nos aseguraremos de que tu comodidad sea lo más prioritario, ¿vale?"
...
translate Spanish ch21_main_15cca953:
    ...
    y "Puede que ya te interese elegir qué libro leer..."
...
translate Spanish ch21_main_47b42db1:
    ...
    mc "Por lo que creo que ya iría tocando elegir uno."
...
translate Spanish ch21_main_4031f60f:
    ...
    y "¡Tampoco quería forzarte a ello!"
...
translate Spanish ch21_main_720ff8ea:
    ...
    mc "Así que, aunque no lea con frecuencia, estaré encantado de escoger un libro si eso quieres que haga."
...
translate Spanish ch21_main_5cc899a6:
    ...
    y 3u "Bueno, como vicepresidenta y tal..."
...
translate Spanish ch21_main_400ef1e7:
    ...
    y "Siento que debería ayudarte a leer algo que sea de tu agrado."
...
translate Spanish ch21_main_bb6c4878:
    ...
    y 1s "No quería que te sintieses apartado..."
...
translate Spanish ch21_end_ad956e20:
    ...
    "En la otra punta del aula, Monika está escribiendo algo en su cuaderno."
...
translate Spanish ch21_end_678374ea:
    ...
    y "Solo intentaba decir algo positivo..."
...
translate Spanish ch21_end_0d84550c:
    ...
    y 2r "¡Siento que mi estilo de vida le sea muy difícil de asimilar a alguien de tu edad mental!"
...
translate Spanish ch21_end_63390205:
    ...
    n "¡Diciendo esas cosas solo me das la razón!"
...
translate Spanish ch21_end_f5bbcc4e:
    ...
    n 4e "La mayoría de la gente aprende a comportarse tras superar la secundaria, por si no lo sabías."
...
translate Spanish ch21_end_3171f8f3:
    ...
    y "Si realmente quieres demostrar algo, ¡deja de molestar a los demás con tu repugnante actitud!"
...
translate Spanish ch21_end_d558e8d9:
    ...
    y "¿Crees que puedes compensar tu personalidad tóxica solo con vestirte y comportarte de forma adorable?"

# game/script-ch21.rpy:245
translate Spanish ch21_end_22920899:

    # y 1k "The only cute thing about you is how hard you try."
    y 1k "Lo único adorable que hay en ti es lo mucho que intentas ser alguien que no eres."
...
translate Spanish ch21_end_07dadfb4:
    ...
    n "¡Deja que [player] escuche lo que piensas en realidad!"

# game/script-ch21.rpy:258
translate Spanish ch21_end_a42a7d2b:

    # n "I'm sure he'll be head over heels for you after this!"
    n "¡Estoy segura de que le parecerás encantadora después de hacerlo!"
...
translate Spanish ch21_end_d2e9959c:
    ...
    "De repente, Yuri se gira hacia mí, como si se hubiese percatado de mi presencia."
...
translate Spanish ch21_end_7d9d98c4:
    ...
    "{cps=*2}¡Pero si le doy la razón a alguna, probablemente piense mejor de mí!{/cps}{nw}"

# game/script-ch21.rpy:279
translate Spanish ch21_end_41c4781c:

    # "{cps=*2}So, of course that's going to be...!{/cps}{nw}"
    "{cps=*2}¡Y le daré la razón claramente a...!{/cps}{nw}"
...
translate Spanish menu_click_cb621371:
    ...
    m "Vaya presidenta estoy hecha, ¿verdad?"

# game/script-ch21.rpy:359
translate Spanish menu_click_1a371204:

    # m 1m "I can't even confront my own club members properly..."
    m 1m "Ni siquiera puedo hacerle frente como corresponde a los miembros de mi propio club..."
...
translate Spanish menu_click_b7464616:
    ...
    m "Ojalá fuera de vez en cuando algo más firme."
...
translate Spanish menu_click_0aa55db2:
    ...
    m "Bueno, parece que ya han terminado..."
...
translate Spanish menu_click_5eb4546c:
    ...
    "Yuri, sentada en su pupitre, se balancea hacia adelante y hacia atrás con las manos en la frente."
...
translate Spanish menu_click_7031a8ce:
    ...
    "No tengo ni la más remota idea de lo que Yuri puede haberle dicho a Natsuki."

# game/script-ch21.rpy:389
translate Spanish menu_click_1e020a7e:

    # "Or did."
    "O de lo que puede haberle hecho."
...
translate Spanish menu_click_f4e93bf7:
    ...
    m "Sabemos que no pretendías hacer nada malo."
...
translate Spanish menu_click_35d4e88d:
    ...
    m 1j "Además, estoy segura de que Natsuki mañana ya se habrá olvidado de todo."

# game/script-ch21.rpy:399
translate Spanish menu_click_51f3751d:

    # m 1a "Completely."
    m 1a "Completamente segura."
...
translate Spanish menu_click_78755f7e:
    ...
    m "En fin, la sesión ha terminado, por lo que ya podéis volver a casa si queréis."
...
translate Spanish menu_click_b187a000:
    ...
    m 2i "Lo dices como si por alguna razón, no me quisieras por aquí, Yuri."
...
translate Spanish menu_click_87fe856c:
    ...
    m 1d "Parece que no tengo elección, ¿eh?"
...
translate Spanish menu_click_3ff20095:
    ...
    y 1s "Pero aprecio de corazón que lo entiend{nw}"
...
translate Spanish menu_click_d7508341:
    ...
    y glitch "Pero aprecio de corazón que lo entiend{fast}[gtext] [gtext][gtext]{nw}"
